"""Add pending_uploads table for temporary upload tracking

Revision ID: add_pending_uploads_table
...
revision: str = 'add_pending_uploads_table'
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_pending_uploads_created_at'), table_name='pending_uploads')
    op.drop_index(op.f('ix_pending_uploads_user_id'), table_name='pending_uploads')
    op.drop_index(op.f('ix_pending_uploads_id'), table_name='pending_uploads')
